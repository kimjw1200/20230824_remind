...
public class HomeController {
    ...
    public void init() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize(
        		"NCSSNS3K01BECDOX",
        		"0JMVBMUOVQ9L1UIIX4YSVNSJ90HRZSRC",
	...
	public String sendMail(
		...
		helper.setFrom("chlrlrms1@gamil.com", "MASTER_CGG");
		helper.setTo(email);
	...
	public Map<String, String> sendSMS(
		...
		message.setFrom("01098005590");
		message.setTo(userPhoneNumber);
		message.setText("KJW에서 전송한 메세지["+code+"] 코드를 확인 후 입력해주세요."); 
